...
export type IPersonalAddressCompleteAction = ThunkAction<void, IStore, void, CallHistoryMethodAction>;

export const pageComplete = (): IPersonalAddressCompleteAction => (
